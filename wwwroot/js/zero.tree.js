    ...
    var tree = function (config) {
        ...
        bindClickEvent = function () {
            ...
            if (isInputMode) {
                ...
                inputs.input2.onfocus = function (e) {
                    ...
                    rootNode.style.width = (this.offsetWidth-2) + 'px';
                    rootNode.style.marginLeft = point.x + 'px';
                    rootNode.style.marginTop = point.y + 'px';
        ...
        init = function () {
            ...
            if (isInputMode) {
                ...
                rootNode = $.htmlStrToDom('<div style="display:none;position:absolute;max-height:318px;" for="' + id + '"></div>').prependTo(body)[0];
            } else {
                rootNode = target;
            }
